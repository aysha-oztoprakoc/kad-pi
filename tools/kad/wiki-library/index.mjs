...
export function semanticStatus({available=false,root=vaultRoot()}={}) { return {provider:'ai-memory',state:available?'AVAILABLE':'UNAVAILABLE',authority:'DERIVED',fallback:available?'deterministic-index':'deterministic-index',canonical_revision:revision(root)}; }
